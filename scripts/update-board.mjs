...
const roleOrder = ["ceo", "cto", "ba", "designer", "dev", "dba", "ops", "qa", "devils-advocate"];
const roleLabel = {
  ceo: "CEO", cto: "CTO", ba: "BA", designer: "Designer", dev: "Dev",
  dba: "DBA", ops: "Ops", qa: "QA", "devils-advocate": "Devil's Advocate",
};
