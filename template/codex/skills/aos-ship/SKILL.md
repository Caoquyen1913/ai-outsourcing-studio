---
name: aos-ship
description: Finalize and sign off the active AI Outsourcing Studio project. Use when the user wants to ship, release, or do final QA/CEO sign-off on the current project.
---

# AI Outsourcing Studio — Ship
