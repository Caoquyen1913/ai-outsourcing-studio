---
description: Submit a new product idea to the CEO of the outsourcing studio (fully autonomous mode)
...
3. If no active project, spawn the **ceo** subagent via the Task tool with this prompt (verbatim — do NOT soften the autonomy clause):

   > A new pitch is in `.company/inbox.md`. Read it and run your Phase 1–7 workflow from `.claude/agents/ceo.md`.
   >
   ...
   > - When BRIEF.md is ready (with `## Win conditions`, `## Assumptions`, `## Delegated decisions`, zero `## Open questions`), invoke `Skill("handoff", ...)` to BA **immediately**. Do NOT pause to confirm BRIEF with the user.
